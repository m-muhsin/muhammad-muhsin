    ...
    <div style={{ display: 'flex', flex: 'row' }}>
      ...
      >
        <p>
          ...
          I'm Muhammad, a full stack engineer from Colombo, Sri Lanka.
        </p>
        <p>
          I'm super passionate about WordPress and React and work with them on a
          daily basis. I'm also a writer, speaker, mentor and open-source
          contributor.
        </p>
        <p>
        ...
        <p>
          I'm currently open to freelance projects and job opportunities. Get in
          touch with me via{' '}
          <a
            href="mailto:muhammad.muhseen@gmail.com?Subject=Hello%20Muhammad"
            target="_top"
          >
            email
          </a>{' '}
